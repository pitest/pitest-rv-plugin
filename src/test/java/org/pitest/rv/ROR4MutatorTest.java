...
public class ROR4MutatorTest extends MutatorTestBase {

    @Before
    public void setupEngineToMutateOnlyConditionals() {
        createTesteeWith(ROR4Mutator.ROR4);
    }
    ...
    @Test
    public void shouldReplaceIFLTWithIFEQ() throws Exception {
    ...
    @Test
    public void shouldReplaceIF_ICMPLTWithIF_ICMPEQ() throws Exception {
    ...
    @Test
    public void shouldReplaceIFLEWithIFEQ() throws Exception {
    ...
    @Test
    public void shouldReplaceIF_ICMPLEWithIF_ICMPEQ() throws Exception {
    ...
    @Test
    public void shouldReplaceIFGTWithIFEQ() throws Exception {
    ...
    @Test
    public void shouldReplaceIF_ICMPGTWithIF_ICMPEQ() throws Exception {
    ...
    @Test
    public void shouldReplaceIFGEWithIFEQ() throws Exception {
    ...
    @Test
    public void shouldReplaceIF_ICMPGEWithIF_ICMPEQ() throws Exception {
    ...
    @Test
    public void shouldReplaceIFEQWithIFGE() throws Exception {
        final Mutant mutant = getFirstMutant(HasIFEQ.class);
        assertMutantCallableReturns(new HasIFEQ(1), mutant, "was zero");
        assertMutantCallableReturns(new HasIFEQ(0), mutant, "was zero");
    ...
    @Test
    public void shouldReplaceIF_ICMPEQWithIF_CMPGE() throws Exception {
        final Mutant mutant = getFirstMutant(HasIF_ICMPEQ.class);
        assertMutantCallableReturns(new HasIF_ICMPEQ(1), mutant, "was zero");
        assertMutantCallableReturns(new HasIF_ICMPEQ(0), mutant, "was zero");
    ...
    @Test
    public void shouldReplaceIFNEWithIFGE() throws Exception {
    ...
    @Test
    public void shouldReplaceIF_ICMPNEWithIF_CMPGE() throws Exception {
