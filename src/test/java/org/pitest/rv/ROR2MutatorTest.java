...
public class ROR2MutatorTest extends MutatorTestBase {
    ...
    @Test
    public void shouldReplaceIFLTWithIFGT() throws Exception {
    ...
    @Test
    public void shouldReplaceIFLEWithIFGT() throws Exception {
    ...
    @Test
    public void shouldReplaceIF_ICMPLEWithIF_ICMPGT() throws Exception {
    ...
    @Test
    public void shouldReplaceIF_ICMPGTWithIF_ICMPLE() throws Exception {
    ...
    @Test
    public void shouldReplaceIFGEWithIFLE() throws Exception {
    ...
    @Test
    public void shouldReplaceIF_ICMPGEWithIF_ICMPLE() throws Exception {
    ...
    @Test
    public void shouldReplaceIFEQWithIFLE() throws Exception {
    ...
    @Test
    public void shouldReplaceIF_ICMPEQWithIF_CMPLE() throws Exception {
    ...
    @Test
    public void shouldReplaceIFNEWithIFLE() throws Exception {
    ...
    @Test
    public void shouldReplaceIF_ICMPNEWithIF_CMPLE() throws Exception {
