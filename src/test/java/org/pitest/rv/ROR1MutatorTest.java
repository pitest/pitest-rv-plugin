...
public class ROR1MutatorTest extends MutatorTestBase {

    @Before
    public void setupEngineToMutateOnlyConditionals() {
        createTesteeWith(ROR1Mutator.ROR1);
    }
    ...
    @Test
    public void shouldReplaceIF_ICMPLTWithIF_ICMPLE() throws Exception {
    ...
    @Test
    public void shouldReplaceIFLEWithIFLT() throws Exception {
    ...
    @Test
    public void shouldReplaceIF_ICMPLEWithIF_ICMPLT() throws Exception {
    ...
    @Test
    public void shouldReplaceIFGTWithIFLT() throws Exception {
    ...
    @Test
    public void shouldReplaceIF_ICMPGTWithIF_ICMPLT() throws Exception {
    ...
    @Test
    public void shouldReplaceIF_ICMPGEWithIF_ICMPLT() throws Exception {
    ...
    @Test
    public void shouldReplaceIFEQWithIFLT() throws Exception {
    ...
    @Test
    public void shouldReplaceIF_ICMPEQWithIF_CMPLT() throws Exception {
    ...
    @Test
    public void shouldReplaceIFNEWithIFLT() throws Exception {
    ...
    @Test
    public void shouldReplaceIF_ICMPNEWithIF_CMPLT() throws Exception {
